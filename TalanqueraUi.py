...
class CallServer:
    ...
    def LogIn(self, userName='', userPass=''):
        ...
        log.write("# [func.LogIn]:Llamado desde la funcion de Login de la forma. Valida usuario y contrase�a."
                  " Parametros: Usuario={0} ; Contrase�a={1}\n".format(userName, userPass))
...
class TalanqueraUi(QtGui.QMainWindow, Ui_MainWindow):
    ...
    def __init__(self):
        ...
        # Setup del frame. Se fija el tama�o de la pantalla para deshabilitar el boton de maximizar.
    ...
    def ado(self, dbpath):
        ...
        try:
            ...
            conn.Open(dsn)
            self.alert("CONNECTION SUCCESSFUL!", "�Conexi�n exitosa!")
            ...
            self.alert("CONNECTION ERROR!",
                       "�Se ha producido un error de conexi�n!" +
    ...
    def testodb(self, direct):  # testodb (odb = Oracle Data Base).
        ...
        if resp == 0:
            ...
            self.alert("Success!", "�Conexi�n estable a internet!")
            return True
        else:
            log.write("# [func.testodb]:Conexion no disponible...")
            self.alert("Failed!", "�Revise su conexi�n a internet!")
            return False
    ...
    def odbc(self, dbruote):
        ...
        try:
            ...
            self.alert("Success!", "�Conexi�n exitosa!")
    ...
    def login(self, usr, pwd):
        ...
        with CallServer(WSURL) as ws:
            ...
            if response['ACK'] == '1':
                ...
                self.alert("Control Condominio", "�Usuario y Contrase�a V�LIDOS!")
                ...
                self.alert("Control Condominio", "�Usuario y Contrase�a NO V�LIDOS!")
